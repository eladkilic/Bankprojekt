...
public class KontoOberflaeche extends BorderPane {
	 ...
	 */
	public KontoOberflaeche(Konto konto, KontoController controller) {
		this.model= konto;
...
//		model.imPlusProperty().addListener(e-> controller.farbeAendern());
		//--------------
		...
		//--------------
//		txtAdresse.setText("Adresse: "+model.getInhaber().getAdresse());
		...
		//--------------
//		waehrung.valueProperty().addListener(e -> controller.handleWaehrungswechsel(waehrung.getValue()));
		//--------------		
...
//		--------------
		...
		this.getChildren().add(txtNummer);
	}
 ...
 * aktuelle kontostand mit farbe
 * button einzahlen abheben
 * betrag aus textfeld, währung aus choicebox
 * mit meldungen
 * gesperrt zustand anzeigen und mit checkbox ändern
 * adresse angezeigt und mit textfeld geändert
 * 
 * 
 * */
